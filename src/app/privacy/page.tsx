      ...
      <div>
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg mb-6">
            At ROOM, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and
            safeguard your information when you visit our website or use our service.
          </p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">Form Response Data</h3>
          <p className="mb-4">
            When you use our service to create forms and collect responses, we store the data that is submitted through
            these forms. You are the controller of this data, and we are the processor.
          </p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">4. Disclosure Of Data</h2>
  
          <h3 className="text-xl font-bold mt-6 mb-3">Legal Requirements</h3>
          <p className="mb-4">
            ROOM may disclose your Personal Data in the good faith belief that such action is necessary to:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of ROOM</li>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>By email: privacy@room.com</li>
